 ...
 */
function mimo_maps_for_woocommerce_get_language() {
 ...
 */
function mimo_maps_for_woocommerce_register_string( $plugin_name_human_format, $string_name, $value ) {
 ...
 * @param     string   $string_name               The name of the string
 */
function mimo_maps_for_woocommerce_deregister_string( $plugin_name_human_format, $string_name ) {
 ...
 * @param     string   $value					  The value
 */
function mimo_maps_for_woocommerce_get_string( $plugin_name_human_format, $string_name, $value ) {
